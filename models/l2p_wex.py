...
class Learner(BaseLearner):
    ...
    def _train(self, train_loader, test_loader):
        ...
        task_emission_tracker = EmissionsTracker(log_level="critical", project_name="L2PWEX_Task_{}".format(self._cur_task), output_file=self.outpath+"_L2PWEX_per_task_emissions.csv")
    ...
    def _init_train(self, train_loader, test_loader, optimizer, scheduler):
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            losses = 0.0
            correct, total = 0, 0
            epoch_emission_tracker = EmissionsTracker(log_level="critical", project_name="L2PWEX_Task_{}_Epoch_{}".format(self._cur_task,epoch), output_file=self.outpath+"_L2PWEX_per_epoch_emissions.csv")
