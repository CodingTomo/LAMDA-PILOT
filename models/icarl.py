...
class Learner(BaseLearner):
    ...
    def inference_gpu_time(self, model_name, outpath):
        ...
        with torch.no_grad():
            inference_tracker = EmissionsTracker(log_level="critical", project_name="ICARL_inference_Task_{}".format(self._cur_task), output_file=self.outpath+"_ICARL_per_task_inference_emissions.csv")
